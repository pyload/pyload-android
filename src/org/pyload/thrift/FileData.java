...
public class FileData implements TBase<FileData, FileData._Fields>, java.io.Serializable, Cloneable {
  ...
  private static final TField PLUGIN_FIELD_DESC = new TField("plugin", TType.STRING, (short)4);
  private static final TField SIZE_FIELD_DESC = new TField("size", TType.I64, (short)5);
  private static final TField FORMAT_SIZE_FIELD_DESC = new TField("format_size", TType.STRING, (short)6);
  private static final TField STATUS_FIELD_DESC = new TField("status", TType.I32, (short)7);
  private static final TField STATUSMSG_FIELD_DESC = new TField("statusmsg", TType.STRING, (short)8);

...
public class ServiceDoesNotExists extends Exception implements TBase<ServiceDoesNotExists, ServiceDoesNotExists._Fields>, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("ServiceDoesNotExists");
  ...
  static {
    ...
    FieldMetaData.addStructMetaDataMap(ServiceDoesNotExists.class, metaDataMap);
  }
